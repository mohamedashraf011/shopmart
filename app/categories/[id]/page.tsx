...
import { GetCategoryById } from "@/API/getCategoryName";
    ...
    async function loadData() {
      try {
        ...
        const [productsData, categoryData] = await Promise.all([
          GetProductsByCategory(id).catch(() => [] as Iproduct[]),
          GetCategoryById(id),
        ]);
  ...
  if (error) {
    return (
      <div className="container mx-auto py-12 px-4 text-center">
        <h2 className="text-3xl font-bold mb-10">Error Loading Category</h2>
